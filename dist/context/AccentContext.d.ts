...
export declare function resolveAccentTokens(key?: AccentKey, accents?: Record<string, AccentTokens>, tokens?: AccentTokens): Required<AccentTokens>;
export declare function createAccentTokens(baseOrTokens?: AccentKey | AccentTokens, overrides?: AccentTokens): Required<AccentTokens>;
export declare function createAccentPresets(definitions: Record<string, AccentPresetInput>): Record<string, AccentTokens>;
